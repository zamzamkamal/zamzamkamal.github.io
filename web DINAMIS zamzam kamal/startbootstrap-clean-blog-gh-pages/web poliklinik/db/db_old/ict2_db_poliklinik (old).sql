...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 17, 2019 at 11:39 AM
...
('DOKT000001', 'Dr. Santuy', 'Bandung', '0828938', 'POLI000001', 'JDWL000001'),
('DOKT000002', 'Dr.zazaka', 'hantap', '081646811924', 'POLI000002', 'JDWL000001'),
('DOKT000003', 'Dr.zazaka', 'hantap', '088772424', 'POLI000007', 'JDWL000007'),
('DOKT000004', 'Dr.dude', 'jakarta', '777777777', 'POLI000001', 'JDWL000002'),
('DOKT000005', 'Dr.rzkbnp', 'bandung', '32435353', 'POLI000005', 'JDWL000009'),
('DOKT000006', 'Dr.amnda', 'bandung', '0834253333', 'POLI000006', 'JDWL000007'),
('DOKT000007', 'Dr.Slm', 'hantap', '881837381', 'POLI000005', 'JDWL000001');
...
(1, 'Kliknik udah gila', 'Aplikasi Pengelola Data Poliklinik paling madev    ', 'Bandung no 73', 'Kiaracondong', 'Bandung', 'Jawa Barat', 999777, '081646811924', 'zamzamkamal31@gmail.com', 'download (1).png');
...
('JDWL000008', 'jumat', '22:10:00', '23:11:00'),
('JDWL000009', 'libur', '22:00:00', '12:00:00');
...
('BIYA000006', 'Checkup', 5000),
('BIYA000007', 'trapi kesantuyan', 5000);
...
('amd', '695db60322b494d08bc8ddd77732c4f1', 'Admin', 'PGW0000007'),
('dokter', 'd22af4180eee4bd95072eb90f94930e5', 'Dokter', 'PGW0000004'),
('kasir', 'c7911af3adbd12a035b289556d96470a', 'Kasir', 'PGW0000003'),
('pendaftar', '8edc6a0b2e5880aa676b9d229e52d667', 'Pendaftar', 'PGW0000002'),
('rzk', '52bb1e9f36af7a647ad541f7ec90d5a8', 'Dokter', 'PGW0000008'),
('sal', '7794fc517590053809f758b7e16d87ed', 'Dokter', 'PGW0000006'),
('zaza', '8ba97607a1485ccdbe19745ed80cd52d', 'pendaftar', 'PGW0000005');
...
('OBT0000005', 'obat enjoy', 'klm hirup', 'boom', 7000),
('OBT0000006', 'anti galau', 'nike', 'cair', 9300);
...
('PGW0000001', 'Zamzam Admin', 'hantap', '081646811924', 'Pria'),
('PGW0000002', 'Zamzam pendaftar', 'hantap', '081646811921', 'Pria'),
('PGW0000003', 'Zamzam Kasir', 'hantap', '081646811923', 'Pria'),
('PGW0000004', 'Zamzam Dokter', 'hantap', '081646811922', 'Pria'),
('PGW0000005', 'zaza', 'hantap', '089213183471', 'Pria'),
('PGW0000006', 'slm', 'hantap', '08675463725', 'Wanita'),
('PGW0000007', 'amnd', 'hantap', '08129242', 'Wanita'),
('PGW0000008', 'rzkbnp', 'hantap', '0837472742', 'Wanita');
...
INSERT INTO `tb_pemeriksaan` (`kode_pemeriksaan`, `tanggal_pemeriksaan`, `keluhan`, `diagnosa`, `perawatan`, `tindakan`, `berat_badan`, `tensi_diastolik`, `tensi_sistolik`, `no_pendaftaran`, `status_pemeriksaan`) VALUES
('PRS0000001', '2017-01-01', 'a', 'a', 'a', 'a', 1, 1, 1, 22, '0');
...
(22, '2017-01-01', 1, 'PGW0000002', 'PAS0000001', 'JDWL000005');
...
('POLI000005', 'Poli Sayang'),
('POLI000006', 'Poli Cinta'),
('POLI000007', 'Poli Sakit '),
('POLI000008', 'Poli stay');
...
--
ALTER TABLE `tb_rekam_medis_biaya`
  MODIFY `id_rekam_medis_biaya` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
--
-- AUTO_INCREMENT for table `tb_rekam_medis_obat`
--
ALTER TABLE `tb_rekam_medis_obat`
  MODIFY `id_rekam_medis_obat` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
--
