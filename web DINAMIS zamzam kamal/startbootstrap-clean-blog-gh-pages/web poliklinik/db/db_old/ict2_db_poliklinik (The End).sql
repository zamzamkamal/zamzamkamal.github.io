...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 02, 2019 at 04:18 PM
...
('PRS0000004', '2019-11-25', 'kurang kasih sayang', 'kesantuyan', 'b', 'b', 43, 353, 353, 25, '0', '0', 'DOKT000004'),
...
(51, 'PRS0000002', 'BIYA000007'),
(52, 'PRS0000001', 'BIYA000001');
...
(24, 'PRS0000002', 'OBT0000003'),
(25, 'PRS0000002', 'OBT0000004'),
(26, 'PRS0000001', 'OBT0000002'),
(27, 'PRS0000001', 'OBT0000006');
...
--
ALTER TABLE `tb_rekam_medis_biaya`
  MODIFY `id_rekam_medis_biaya` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=53;
--
-- AUTO_INCREMENT for table `tb_rekam_medis_obat`
--
ALTER TABLE `tb_rekam_medis_obat`
  MODIFY `id_rekam_medis_obat` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
--
-- AUTO_INCREMENT for table `tb_rekam_medis_resep`
--
ALTER TABLE `tb_rekam_medis_resep`
  MODIFY `id_rekam_medis_resep` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
--
