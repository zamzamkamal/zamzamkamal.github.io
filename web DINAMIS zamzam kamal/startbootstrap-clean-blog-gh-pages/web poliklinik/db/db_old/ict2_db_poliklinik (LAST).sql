...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 29, 2019 at 04:48 PM
...
('DOKT000003', 'Dr. Zo', 'Jakartaa', '0829977188', 'POLI000002', 'JDWL000003'),
('DOKT000004', 'Dr.zazaka', 'palestina', '1111111111', 'POLI000005', 'JDWL000005'),
('DOKT000005', 'Dr.dddude', 'bandung', '08199999999', 'POLI000003', 'JDWL000007'),
...
(1, 'Kliknik udah gila', 'Aplikasi Pengelola Data Poliklinik  ', 'Bandung', 'Kiaracondong', 'bandung', 'Jawa Barat', 999777, '081646811924', 'zamzamkamal31@gmail.com', 'download (1).png');
...
('PRS0000001', '2019-11-29', 'zzz', 'KLM HIRUP', 'a', 'a', 1, 1, 1, 22, '0', '0', 'DOKT000001'),
('PRS0000002', '3333-03-31', '3444', 'ZIWAN', '4ZC', '44ZC', 4, 45, 45, 22, '0', '0', 'DOKT000003'),
('PRS0000003', '3333-03-31', 'zzz', 'UJANG', 'zz', 'zz', 232, 55323, 657, 22, '0', '0', 'DOKT000001'),
('PRS0000004', '2019-11-25', 'kurang kasih sayang', 'SANTO', 'b', 'b', 43, 353, 353, 22, '0', '0', 'DOKT000003'),
('PRS0000005', '2019-11-21', 'REREEEEZ', 'tR', 'tR', 'tR', 54, 54, 54, 22, '0', '0', 'DOKT000001'),
('PRS0000006', '2019-11-24', 'tttt', 'tttt', 'tttt', 'tttt', 3333, 333, 2222, 22, '1', '1', 'DOKT000003'),
('PRS0000007', '2019-11-22', 'sadboy', 'rr', 'rr', 'rr', 24, 0, 0, 22, '1', '1', 'DOKT000003'),
('PRS0000008', '2019-11-21', 'uu', 'uu', 'uu', 'uu', 0, 0, 0, 22, '1', '1', 'DOKT000003'),
('PRS0000009', '2019-11-29', 'd', 'd', 'd', 'd', 3343, 342, 23, 22, '1', '1', 'DOKT000003'),
('PRS0000010', '2019-11-28', 'dddd', 'serangan santuy', 'serangan santuy', 'ddddddd', 45, 4545, 45, 22, '1', '1', 'DOKT000003'),
('PRS0000011', '2019-11-28', 'jangar', 'p', 'p', 'p', 9, 99, 999, 22, '0', '0', 'DOKT000003'),
('PRS0000012', '2019-11-28', 'kaasupan setan', 'surss', 'surss', '32', 3, 3, 3, 22, '0', '0', 'DOKT000003'),
('PRS0000013', '2019-11-28', 'rrerere', 'erere', 'rererer', 'erer', 12, 131, 311, 22, '0', '0', 'DOKT000003'),
('PRS0000014', '2019-11-16', 'A', 'w', 'w', 'w', 0, 22, 33, 22, '1', '1', NULL),
('PRS0000015', '2019-11-16', 'santet', 'ZIWAN', 'ZIWARDI', 'UJANG', 123, 0, 0, 22, '1', '0', 'DOKT000004'),
('PRS0000016', '2019-11-15', 'galau', 'galau', 'g', 'g', 55, 0, 0, 22, '', '1', NULL),
('PRS0000017', '2019-11-15', 'kurang dota', 'dota', 'dota', 'dota', 999, 999, 999, 22, '', '1', NULL),
('PRS0000018', '2019-11-21', 'terlalu santuy', 'terlalu santuy1', 'terlalu santuy2', 'terlalu santuy3', 333, 333, 333, 25, '', '1', NULL);
...
(34, 'PRS0000009', 'BIYA000004'),
(35, 'PRS0000003', 'BIYA000004'),
(38, 'PRS0000008', 'BIYA000005'),
(39, 'PRS0000007', 'BIYA000005'),
...
--
ALTER TABLE `tb_rekam_medis_biaya`
  MODIFY `id_rekam_medis_biaya` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=41;
--
-- AUTO_INCREMENT for table `tb_rekam_medis_obat`
--
ALTER TABLE `tb_rekam_medis_obat`
  MODIFY `id_rekam_medis_obat` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
--
-- AUTO_INCREMENT for table `tb_rekam_medis_resep`
--
ALTER TABLE `tb_rekam_medis_resep`
  MODIFY `id_rekam_medis_resep` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
--
