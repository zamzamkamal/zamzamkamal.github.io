...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 01, 2019 at 05:19 PM
...
('PRS0000002', '3333-03-31', '3444', 'santuy', '4ZC', '44ZC', 4, 45, 45, 22, '0', '0', 'DOKT000001'),
('PRS0000003', '3333-03-31', 'zzz', 'butuh', 'zz', 'zz', 232, 55323, 657, 22, '0', '0', 'DOKT000001'),
('PRS0000004', '2019-11-25', 'kurang kasih sayang', 'kesantuyan', 'b', 'b', 43, 353, 353, 22, '0', '0', 'DOKT000001'),
('PRS0000005', '2019-11-21', 'REREEEEZ', 'tR', 'tR', 'tR', 54, 54, 54, 22, '1', '1', 'DOKT000001'),
...
--
ALTER TABLE `tb_rekam_medis_biaya`
  MODIFY `id_rekam_medis_biaya` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=42;
--
-- AUTO_INCREMENT for table `tb_rekam_medis_obat`
--
ALTER TABLE `tb_rekam_medis_obat`
  MODIFY `id_rekam_medis_obat` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
--
-- AUTO_INCREMENT for table `tb_rekam_medis_resep`
--
ALTER TABLE `tb_rekam_medis_resep`
  MODIFY `id_rekam_medis_resep` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
--
