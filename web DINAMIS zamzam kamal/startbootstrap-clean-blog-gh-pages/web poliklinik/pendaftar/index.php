...
if (@$_SESSION['username']) 
 {
  if (@!$_SESSION['type_user']    =="Pendaftar"   )     {header("location:../pendaftar/index.php");}
    else {
...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand navbar-dark bg-dark static-top">
    ...
    <a class="navbar-brand mr-1" href="#"><B>Pendaftar Poliklinik</a></B>
 ...
 <ul class="sidebar navbar-nav">
  ...
  ?>
      ...
      <li <?php if ($page == "pasien_tambah") {?> class="nav-item active" <?php } ?> ">
        <a class="nav-link" href="?page=pasien_tambah">
         <i class='fas fa-user-injured'></i>
          <span>Pasien Baru</span></a>
      </li>

      <li <?php if ($page == "pasien") {?> class="nav-item active" <?php } ?> ">
        <a class="nav-link" href="?page=pasien">
          <i class='fas fa-book-reader'></i>
          <span>Data Pasien</span></a>
      </li>

      <li <?php if ($page == "pendaftar") {?> class="nav-item active" <?php } ?> ">
