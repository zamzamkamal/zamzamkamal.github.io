...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand navbar-dark bg-dark static-top">
    ...
    <a class="navbar-brand mr-1" href="#"><B>Admin Poliklinik</a></B>
 ...
 <ul class="sidebar navbar-nav">
  ...
  ?>
      ...
      <li <?php if ($page == "pegawai") {?> class="nav-item active" <?php } ?> ">
        <a class="nav-link" href="?page=pegawai">
         <i class="fas fa-stethoscope"></i>
          <span>Data Pegawai</span></a>
      </li>

      <li <?php if ($page == "poli") {?> class="nav-item active" <?php } ?> ">
        <a class="nav-link" href="?page=poli">
          <i class="fas fa-book-medical"></i>
          <span>Data Poliklinik</span></a>
      </li>

      <li <?php if ($page == "obat") {?> class="nav-item active" <?php } ?> ">
        <a class="nav-link" href="?page=obat">
          <i class="fas fa-pills"></i>
          <span>Data Obat</span></a>
      </li>
   
      <li <?php if ($page == "biaya") {?> class="nav-item active" <?php } ?> ">
        <a class="nav-link" href="?page=biaya">
          <i class="fas fa-money-bill-wave"></i>
          <span>Jenis Biaya</span></a>
      </li>
      
      <li <?php if ($page == "dokter") {?> class="nav-item active" <?php } ?> ">
        <a class="nav-link" href="?page=dokter">
          <i class="fas fa-user-md"></i>
          <span>Data Dokter</span></a>
      </li>

      <li <?php if ($page == "jadwal") {?> class="nav-item active" <?php } ?> ">
        <a class="nav-link" href="?page=jadwal">
          <i class="fas fa-fw fa-table"></i>
          <span>Data Jadwal</span></a>
      </li>

      <li <?php if ($page == "info") {?> class="nav-item active" <?php } ?> ">
        <a class="nav-link" href="?page=info">
          <i class="fas fa-info-circle"></i>
          <span>Info Poliklinik</span></a>
      </li>

        <li <?php if ($page == "database") {?> class="nav-item active" <?php } ?> ">
